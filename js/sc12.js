...
switch (level) {
  ...
  case "hard":
    ...
    break;          
        ...
        // Стили
         const frame = new Frame("fit", 1500, 1500,"", lighten, "pic-12.jpg", "images/puzzle/");
         frame.on("ready", ()=>{ // ES6 Arrow Function - similar to function(){}
            ...
            //  Размер отверстий в пазлах
             ...
             const pic = asset("pic-12.jpg").clone().center().alp(.3).vis(true); // checkbox later to turn on
             ...
             const pics = chop(asset("pic-12.jpg"), numX, numY, false, extra); 
