...
switch (level) {
  ...
  case "hard":
    ...
    break;          
        ...
        // Стили
         const frame = new Frame("fit", 1200, 1500,"", lighten, "pic-16.jpg", "images/puzzle/");
         frame.on("ready", ()=>{ // ES6 Arrow Function - similar to function(){}
            ...
            //  Размер отверстий в пазлах
             ...
             const pic = asset("pic-16.jpg").clone().center().alp(.3).vis(true); // checkbox later to turn on
             ...
             const pics = chop(asset("pic-16.jpg"), numX, numY, false, extra); 
            ...
            //  Размер текста с собраными пазлами
             ...
             const stats = new Label({        
                 ...
                 italic:false,
                 align:LEFT
             }).centerReg().pos(100,1350,LEFT,TOP);
